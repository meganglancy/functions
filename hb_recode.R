...
hb_recode <- function(hb_in, recode_to = "long", and_choice = "and") {
  ...
  if (recode_to == "short") {
    hb_out <- dplyr::case_when(
      ...
      hb_in %in% c("S08000007", "S08000021", "S08000031", "GGC", "GC", "GG", "GGHB", "GREATER GLASGOW AND CLYDE", "GREATER GLASGOW & CLYDE") ~ "GC",
      hb_in %in% c("S08000006", "S08000020", "GR", "GRA", "GRAMPIAN") ~ "GR",
      hb_in %in% c("S08000008", "S08000022", "HG", "HI", "HIG", "HIGHLAND", "HIGHLANDS") ~ "HG",
    ...
    hb_out <- dplyr::case_when(
      ...
      hb_in %in% c("S08000008", "S08000022", "HG", "HI", "HIG", "HIGHLAND", "HIGHLANDS") ~ "Highland",
