hblong <- function(hbcode, and = "and") {
  hbcode <- stringr::str_trim(hbcode, "both")
  hb_long_code <- dplyr::case_when(
    ...
    hbcode %in% c("S08000007", "S08000021", "GGC", "GC", "GGHB") ~ "Greater Glasgow and Clyde",
    hbcode %in% c("S08000006", "S08000020", "GR", "GRA") ~ "Grampian",
    hbcode %in% c("S08000008", "S08000022", "HG", "HIG") ~ "Highlands",
    hbcode %in% c("S08000009", "S08000023", "LN", "LAN") ~ "Lanarkshire",
